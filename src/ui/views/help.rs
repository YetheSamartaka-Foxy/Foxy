    ...
    fn render_selected_help_tab(&self, ui: &mut Ui) {
        match self.current_help_tab {
            ...
            HelpTab::GettingStarted => self.render_help_page(
                ...
                &[
                    "Set up paths in Settings first: point Arma 3 Directory to your game installation, and optionally configure Steam Directory, Temporary Directory, and Addon Backup Directory.",
            ...
            HelpTab::RepositorySpacesAndAddons => self.render_help_page(
                ...
                &[
                    ...
                    "External addons are addons that are available outside the repository itself. Foxy can discover them from repository-space shared paths, additional search folders from Settings, and Steam Workshop content when enabled.",
            ...
            HelpTab::SettingsAndStatus => self.render_help_page(
                ...
                &[
                    "Use the Application settings tab to configure language, game paths, temporary storage, startup behavior, and other global options.",
                    ...
                    "Use the repository view visibility settings to show or hide the Editor Missions list and Servers list globally, with per-repository overrides when needed.",
                    "Use the Customization tab if you want to change UI font sizes or palette colors without touching repository data.",
                    "Use the Additional search folders tab to register directories where Foxy discovers external addons.",
                    "Use the Cleanup tab to find and remove addons that are no longer used by any repository.",
                    "Use the TS3 Plugins tab to discover, install, and update TeamSpeak 3 plugins found in your repository addons.",
            ...
            HelpTab::Troubleshooting => self.render_help_page(
                ...
                &[
                    ...
                    "If external addons are not detected, verify that the search folders are configured in Settings and that Steam Workshop scanning is enabled if you use Workshop content.",
