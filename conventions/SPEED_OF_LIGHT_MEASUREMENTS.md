...
| O3 first-check hash, NVMe | 67% calibrated on the earlier warm row; the new held-out lane validates representation rather than claiming a physical ratio | Every payload byte is hashed once; two rotated trials selected aggressive then balanced, with 2.62 GB / 208-file held-out rates at 87% and 120% of their selected sample rates; total hash service was 0.518 s and 0.455 s | Clean commit `e14b695`, oracle pass, Sept 18 `20260918T152851Z-18e6e318` | Held-out sufficiency passes, but the winner changes with trial order. Do not attribute a profile-choice win until selection is stable across file-group assignment |
