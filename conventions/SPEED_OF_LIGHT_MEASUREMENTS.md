...
| O2 delta, four files | 2-3% calibrated against B1 (5.2 MB; latency- and apply-bound) | Same-state affected-file control: 2.167 s patch median versus 5.225 s full-file median, 2.41x faster and 58.52% less elapsed | Both arms repaired the same four files; 5.16 MB versus 207.54 MB transferred, 97.52% fewer network bytes, five paired samples and ten oracle passes, Sept 18 `20260918T060148Z-0a675d7c` | Patch elapsed and byte savings are established for this four-file mutation; full-file spread was 4.803-6.062 s versus patch 2.161-2.175 s |
